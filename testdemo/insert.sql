...
UPDATE player_info SET pvp_match_count = 17, pvp_win_rate = 66.67 WHERE user_id = 1;
UPDATE player_info SET pvp_match_count = 16, pvp_win_rate = 53.33 WHERE user_id = 2;
UPDATE player_info SET pvp_match_count = 18, pvp_win_rate = 88.24 WHERE user_id = 3;
UPDATE player_info SET pvp_match_count = 16, pvp_win_rate = 46.67 WHERE user_id = 4;
UPDATE player_info SET pvp_match_count = 16, pvp_win_rate = 80.00 WHERE user_id = 5;
UPDATE player_info SET pvp_match_count = 16, pvp_win_rate = 60.00 WHERE user_id = 6;
UPDATE player_info SET pvp_match_count = 16, pvp_win_rate = 33.33 WHERE user_id = 7;
UPDATE player_info SET pvp_match_count = 15, pvp_win_rate = 73.33 WHERE user_id = 8;
UPDATE player_info SET pvp_match_count = 16, pvp_win_rate = 26.67 WHERE user_id = 9;
UPDATE player_info SET pvp_match_count = 15, pvp_win_rate = 92.86 WHERE user_id = 10;
UPDATE player_info SET pvp_match_count = 16, pvp_win_rate = 40.00 WHERE user_id = 11;
UPDATE player_info SET pvp_match_count = 15, pvp_win_rate = 100.00 WHERE user_id = 12;
UPDATE player_info SET pvp_match_count = 16, pvp_win_rate = 20.00 WHERE user_id = 13;
UPDATE player_info SET pvp_match_count = 16, pvp_win_rate = 13.33 WHERE user_id = 14;
UPDATE player_info SET pvp_match_count = 16, pvp_win_rate = 0.00 WHERE user_id = 15;
